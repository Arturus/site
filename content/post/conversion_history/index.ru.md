...
Благодаря использованию [SHAP values](../conversion_factors#shap)
...
Наличие такой истории даст нам 
...
Работа полученных моделей будет оцениваться на тех же [сайтах](../conversion_factors/#%D1%81%D0%B0%D0%B9%D1%82%D1%8B) , что и в предыдущей статье.   
...
сконструированные по историческим данным. Пример нескольких таких признаков:
...
Некоторые виды моделей, например деревья решений,
...
По результатам feature selection для каждого сайта
